...
Route::middleware(['can-view-posts'])->group(
    function(){
...
Route::get('/login',[LoginUser::class,'login'])->name('login')->middleware('guest');
Route::post('/login',[LoginUser::class,'store'])->name('login.store')->middleware('guest');
